...
import 'package:flutter_hasura/app/models/message_model.dart';
import 'package:flutter_hasura/app/models/user_model.dart';
...
class AppRepository extends Disposable {
  ...
  Future<dynamic> sendMessage(String message, int userId) async {
    var query = """
